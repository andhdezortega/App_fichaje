...
public class FichajeDAO {
   ...
   public boolean crear(FichajeModel fichaje) {
    // Calcular horas extra si hay entrada y salida
    int horasExtra = 0;
    ...
    String sql = "INSERT INTO fichajes (nombre, apellido, rol, fecha, entrada, salida, descanso, comida, horas_semanales, horas_extra, estado) " +
                 "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    try (Connection conn = DatabaseConnection.getConnection();
        ...
        pstmt.setInt(10, horasExtra); // <-- nuevo campo
        pstmt.setBoolean(11, fichaje.isEstado());
