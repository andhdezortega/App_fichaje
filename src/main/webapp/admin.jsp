...
<!-- ------------BOTONES DE HORAS EXTRA-------- -->
<% if (fichajeSeleccionado != null) { %>
    <div class="panel-overtime" style="margin-bottom:14px; padding:10px; background:#1f2a44; border-radius:6px;">
        <p style="margin:0 0 8px 0;">Horas extra actuales: <strong><%= fichajeSeleccionado.getHorasExtra() %> min</strong></p>
        <p style="margin:0 0 8px 0;">Horas aprobadas: <strong><%= fichajeSeleccionado.getAprobadas() %> min</strong></p>
        <div style="display:flex; gap:8px;">
            
            <button type="button" onclick="aprobarHorasExtra(<%= fichajeSeleccionado.getId() %>)" class="btn-accion small-btn aprobar">
                Aprobar horas extra
            </button> 
            <button type="button" onclick="denegarHorasExtra(<%= fichajeSeleccionado.getId() %>)" class="btn-accion small-btn denegar">
                Denegar horas extra
            </button>
        ...
        <table id="tablaFichajes" class="admin-table">
            <thead>
                <tr>
                    ...
                    <th>Horas <br>Extra (min)</th>
                    <th>Aprobadas <br>(min)</th>
                    <th>Horas/semana</th>
                    <th>En producción</th>
                    <th>Acciones</th>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <%
                            ...
                            int mostrar = horasExtraBD;
                        %>
                        <%= mostrar %>  
                    </td>
                    <td><%= f.getAprobadas() %></td> 
