        ...
        <form id="formFichaje" method="post" action="<%= (fichajeSeleccionado != null) ? "ActualizarFichaje" : "InsertarFichaje" %>">
            ...
            <% if (fichajeSeleccionado != null) { %>
                <div class="panel-overtime" style="margin-bottom:16px; padding:12px; background:#1f2a44; border-radius:6px;">
                    ...
                    <p style="margin:0 0 8px 0;">Pendiente total del usuario: <strong><%= fichajeDAO.sumarHorasExtraPendientesPorUsuario(fichajeSeleccionado.nombre) %></strong></p>
                    <div style="display:flex; align-items:center; gap:8px; margin-bottom:8px;">
                        <label for="aprobarHorasExtra" style="display:flex; align-items:center; gap:6px; cursor:pointer;">
                            <input type="checkbox" id="aprobarHorasExtra" name="aprobarHorasExtra" form="formFichaje" <%= ("aprobado".equalsIgnoreCase(String.valueOf(fichajeSeleccionado.estadoHorasExtra))) ? "checked" : "" %>>
                            Aprobar horas extra
                        </label>
                    </div>
                    <p style="margin:0;">Estado: <strong><%= fichajeSeleccionado.estadoHorasExtra != null ? fichajeSeleccionado.estadoHorasExtra : "-" %></strong></p>
                </div>
            <% } %>
        ...
        <table id="tablaFichajes" class="admin-table">
            ...
            <% for (FichajeMock f : fichajes) { %>
                <tr>
                    ...
                    <td><%= f.horasExtraMinutos != null ? f.horasExtraMinutos : 0 %></td>
